...
In this exercise we are trying to recreate a plot examining how political affiliation translated to the 2015 Brexit referendum.
...
Next, we load the data into R using read_csv
...
We can see that constituencies that voted heavily for UKIP voted Leave. This was similar for Conservatives constituencies but the effect of increase was much weaker. 

On the other hand, as a bigger proportion of constituents voted for LibDem or Labour, smaller vote proportion was observed.
